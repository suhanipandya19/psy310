...
expName = 'intentional binding task'  # from the Builder filename that created this script
...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='C:\\Users\\SUHANI PANDYA\\OneDrive\\Lab In Psychology\\Intentional Binding Task\\intentional binding task_lastrun.py',
...
def run(expInfo, thisExp, win, globalClock=None, thisSession=None):
    ...
    text = visual.TextStim(win=win, name='text',
        text='Report the delay between the key press and the beep sound (0-999); click submit after entering the value',
        font='Arial',
    ...
    trials = data.TrialHandler(nReps=40.0, method='random', 
        ...
        trialList=data.importConditions('C:/Users/SUHANI PANDYA/Downloads/conditions.xlsx'),
