...
expName = 'adaptive_staircase'  # from the Builder filename that created this script
...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='C:\\Users\\SUHANI PANDYA\\OneDrive\\Lab In Psychology\\adaptive_staircase_lastrun.py',
...
def run(expInfo, thisExp, win, globalClock=None, thisSession=None):
    ...
    level = thisStair = 10.0  # initialise some vals
